# genpark-agent-task-evaluation-benchmark-harness-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Real-world agent task evaluation & benchmark harness synthesizer (oqoqo style)
